...
,"back":"Quay lại","brand.name":"Bò Vàng","brand.sub":"Tài Lộc Bò Vàng","trade.amountUsdt":"Nhập USDT (tối thiểu 200)","trade.amountNnb":"Nhập số NNB","mine.amountBuy":"Nhập số mua","bind.inputAddr":"Nhập ví cấp trên","trans.toAddr":"Ví nhận (0x...)","trans.nnbAmt":"Số NNB chuyển","invite.startSharing":"Bắt đầu chia sẻ link!","node.dividend":"Cổ tức Node (bình quân)","node.claimableDiv":"Có thể nhận:","node.divHint":"Tích lũy · nhận bất cứ lúc nào","node.divDesc":"10% mỗi lần nhận vào quỹ chia Node; nhận cùng lúc bất cứ lúc nào","common.claim":"Nhận","invite.unlockTitle":"Mở khóa hệ số","invite.unlockDesc":"Mở khóa hệ số bằng doanh thu trực tiếp (U)","invite.tiers":"Thang mở khóa","invite.progress":"Tiến độ hiện tại","invite.nextTier":"Thang kế tiếp","invite.diamond":"Kim cương","trade.myOrders":"Lệnh của tôi","trade.buyOrders":"Lệnh mua","trans.estPerf":"Doanh thu dự kiến","trans.approveHint":"Vui lòng phê duyệt NNB cho hợp đồng trước (1 lần, tái dùng)","perf.directAmt":"Doanh thu trực tiếp","perf.gen":"Hệ số mở khóa","perf.unit":"hệ","perf.maxReached":"Mở khóa tối đa","perf.progress":"Hiện tại","perf.toReach":"còn","perf.unlock":"U mở","perf.remain":"hệ còn"};
// ---------- Bahasa Melayu ----------
NNB_DICT["ms"]={
