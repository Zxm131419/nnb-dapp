...
,"back":"戻る","brand.name":"牛牛コイン","brand.sub":"金 牛 聚 財 運","trade.amountUsdt":"USDT金額入力(最低200)","trade.amountNnb":"NNB数量入力","mine.amountBuy":"購入数量入力","bind.inputAddr":"上級ウォレット入力","trans.toAddr":"受取ウォレット(0x...)","trans.nnbAmt":"送金NNB数","invite.startSharing":"リンクを共有しよう!","node.dividend":"ノード配当(平均)","node.claimableDiv":"受取可能:","node.divHint":"累積、いつでも一括受取","node.divDesc":"受取の10%が配当プールへ、いつでも一括受取可能","common.claim":"受取","invite.unlockTitle":"実績解除代数","invite.unlockDesc":"累計直推実績(U)で代数解除","invite.tiers":"解除段階","invite.progress":"現在進度","invite.nextTier":"次の段階","invite.diamond":"ダイヤモンド","trade.myOrders":"私の注文","trade.buyOrders":"購入注文","trans.estPerf":"予定実績","trans.approveHint":"先にNNBをコントラクトへ承認してください(一度でOK)"};
// ---------- 한국어 ----------
NNB_DICT["ko"]={
...
,"back":"Quay lại","brand.name":"Bò Vàng","brand.sub":"Tài Lộc Bò Vàng","trade.amountUsdt":"Nhập USDT (tối thiểu 200)","trade.amountNnb":"Nhập số NNB","mine.amountBuy":"Nhập số mua","bind.inputAddr":"Nhập ví cấp trên","trans.toAddr":"Ví nhận (0x...)","trans.nnbAmt":"Số NNB chuyển","invite.startSharing":"Bắt đầu chia sẻ link!","node.dividend":"Cổ tức Node (bình quân)","node.claimableDiv":"Có thể nhận:","node.divHint":"Tích lũy · nhận bất cứ lúc nào","node.divDesc":"10% mỗi lần nhận vào quỹ chia Node; nhận cùng lúc bất cứ lúc nào","common.claim":"Nhận","invite.unlockTitle":"Mở khóa hệ số","invite.unlockDesc":"Mở khóa hệ số bằng doanh thu trực tiếp (U)","invite.tiers":"Thang mở khóa","invite.progress":"Tiến độ hiện tại","invite.nextTier":"Thang kế tiếp","invite.diamond":"Kim cương","trade.myOrders":"Lệnh của tôi","trade.buyOrders":"Lệnh mua","trans.estPerf":"Doanh thu dự kiến","trans.approveHint":"Vui lòng phê duyệt NNB cho hợp đồng trước (1 lần, tái dùng)"};
// ---------- Bahasa Melayu ----------
NNB_DICT["ms"]={
